...
axs[0, 0].hist(SBOT_fib_tsr_scores, bins=3, histtype='bar', density='true', rwidth=0.8, color='white', edgecolor='red')
axs[0, 0].set_title('SBOT_fibrosis')
axs[0, 0].set_xticks(range(3))
axs[0, 1].hist(SBOT_cel_tsr_scores, bins=3, histtype='bar', density='true', rwidth=0.8, color='white', edgecolor='red')
axs[0, 1].set_title('SBOT_cellularity')
axs[0, 1].set_xticks(range(3))
axs[0, 2].hist(SBOT_ori_tsr_scores, bins=3, histtype='bar', density='true', rwidth=0.8, color='white', edgecolor='red')
axs[0, 2].set_title('SBOT_orientation')
axs[0, 2].set_xticks(range(3))

axs[1, 0].hist(HGSOC_fib_tsr_scores, bins=3, histtype='bar', density='true', rwidth=0.8, color='white', edgecolor='red')
axs[1, 0].set_title('HGSOC_fibrosis')
axs[1, 0].set_xticks(range(3))
axs[1, 1].hist(HGSOC_cel_tsr_scores, bins=3, histtype='bar', density='true', rwidth=0.8, color='white', edgecolor='red')
axs[1, 1].set_title('HGSOC_cellularity')
axs[1, 1].set_xticks(range(3))
axs[1, 2].hist(HGSOC_ori_tsr_scores, bins=3, histtype='bar', density='true', rwidth=0.8, color='white', edgecolor='red')
axs[1, 2].set_title('HGSOC_orientation')
axs[1, 2].set_xticks(range(3))
plt.show()

fig, axs = plt.subplots(nrows=2, ncols=3)
axs[0, 0].hist(SBOT_stroma_core_fib_tsr_scores, bins=3, histtype='bar', density='true', rwidth=0.8, color='white', edgecolor='red')
axs[0, 0].set_title('SBOT_core_fibrosis')
axs[0, 0].set_xticks(range(3))
axs[0, 1].hist(SBOT_stroma_core_cel_tsr_scores, bins=3, histtype='bar', density='true', rwidth=0.8, color='white', edgecolor='red')
axs[0, 1].set_title('SBOT_core_cellularity')
axs[0, 1].set_xticks(range(3))
axs[0, 2].hist(SBOT_stroma_core_ori_tsr_scores, bins=3, histtype='bar', density='true', rwidth=0.8, color='white', edgecolor='red')
axs[0, 2].set_title('SBOT_core_orientation')
axs[0, 2].set_xticks(range(3))

axs[1, 0].hist(HGSOC_stroma_core_fib_tsr_scores, bins=3, histtype='bar', density='true', rwidth=0.8, color='white', edgecolor='red')
axs[1, 0].set_title('HGSOC_core_fibrosis')
axs[1, 0].set_xticks(range(3))
axs[1, 1].hist(HGSOC_stroma_core_cel_tsr_scores, bins=3, histtype='bar', density='true', rwidth=0.8, color='white', edgecolor='red')
axs[1, 1].set_title('HGSOC_core_cellularity')
axs[1, 1].set_xticks(range(3))
axs[1, 2].hist(HGSOC_stroma_core_ori_tsr_scores, bins=3, histtype='bar', density='true', rwidth=0.8, color='white', edgecolor='red')
