...
def pathOutput = "\\\\anonymized_dir\\result_analysis\\ROI_Img_mask"


List<String> class_txt_list = ["Tumor", "Stroma"]
List<List<Integer>> class_color_list = [[0, 255, 255], [255, 255, 0]]  // tumor & stroma
