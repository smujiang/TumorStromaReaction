...
////////////////////////////////////////////
//output_dir = "/anonymized_dir/Dataset/OvaryCancer/CellClassification"
...
save_fn = pathOutput + File.separator + server.getMetadata().getName().take(server.getMetadata().getName().lastIndexOf('.')) + "_cell_features.txt"
print(save_fn)
