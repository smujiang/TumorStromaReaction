...
output_dir = "/Jun_anonymized_dir/OvaryCancer/StromaReaction/pipeline/neighbor_visualization"
...
for case in case_list:
    ...
    for seg_img_fn in seg_img_fns:
        Img = Image.new("RGBA", (256*5, 256), 'white')
        ...
        xx = roi_img.resize((img_cols, img_rows))
        xx.putalpha(255)
        Img.paste(xx, (0, 0))
        shape = [(85, 85), (85*2, 85*2)]
        ...
        Img.paste(seg_img.resize((85, 85)), (256+85, 85))
