...
//img_fn = "/anonymized_dir/Dataset/OvaryData/QBRC_all/512/OCMC-001_mask/OCMC-001_35972_33137.png"
//print(img_fn)
//mask_dir = "/anonymized_dir/Dataset/OvaryData/QBRC_all/512/OCMC-001_mask"
//mask_dir = "/anonymized_dir/Dataset/OvayCancer/CellClassification/ROI_Masks_out_seg/OCMC-004"
//mask_dir = "/anonymized_dir/Dataset/OvaryData/Patches_out"
mask_dir = "H:\\Jun_anonymized_dir\\OvaryCancer\\CheckRecurrence\\_HE"
...
//        def all_annotations = parseMask(it, bkg, label_txt, Load_As)
        ...
        def start = it.name.indexOf("_HE_")
        char[] buf = new char[end - start-4]
        it.name.getChars(start+4, end, buf,0)
...
static def parseMask(File file, Color bkg, String label_txt, String Load_As){
    ...
    def start = file.name.indexOf("_HE_")
    char[] buf = new char[end - start-4]
    file.name.getChars(start+4, end, buf,0)
    int orig_x = Integer.parseInt(buf.toString())
    buf = new char[end_r - end - 1]
